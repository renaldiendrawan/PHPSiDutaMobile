...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tbl_jadwal (id_anak, umur_anak, jenis_imunisasi, tanggal_imun_timbang, tempat, jam_posyandu) 
            VALUES ('$id_anak', '$umur_anak', '$jenis_imunisasi', '$tanggal_imun_timbang', '$tempat', '$jam_posyandu')";

    if ($koneksi->query($sql) === true) {
        echo "<script type='text/javascript'>
    alert('Jadwal Imunisasi dan Penimbangan Berhasil Ditambah!');
